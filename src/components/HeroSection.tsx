      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        <div className="max-w-xl mx-auto mt-12 animate-slide-up" style={{ animationDelay: "0.2s" }}>
          <div className="bg-secondary-dark/95 backdrop-blur-md rounded-2xl p-8 shadow-2xl border border-secondary-light/20">
            <h2 className="text-xl md:text-2xl font-semibold text-primary-foreground text-center mb-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 px-5 py-4 rounded-lg text-foreground bg-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                required
              />
              <button
                type="submit"
                className="px-6 py-4 bg-gradient-cta text-primary-foreground font-semibold rounded-lg hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-xl whitespace-nowrap"
              >
                Get My Free Quote
              </button>
            </form>
            ...
            {/* Trust badges */}
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 mt-6 text-primary-foreground/90">
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-primary" />
                <span className="text-sm font-medium">No Obligation</span>
              </div>
              <span className="hidden md:block text-primary-foreground/50">•</span>
              <div className="flex items-center gap-2">
                <Check className="w-5 h-5 text-primary" />
